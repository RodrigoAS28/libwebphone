;(function ($, window, document) {
	...
	var namespace   = 'kazoo',
		...
		options = {
                        apiUrl: 'https://kazoo.eu-central-1.us-east-1.aws.tst.pub.talkdeskdev.com:8443/v2/',
                        websocketUrl: 'wss://webrtc.eu-central-1.us-east-1.aws.tst.pub.talkdeskdev.com:5443',
			...
			_onCallActionClick: function _onCallActionClick (event) {
				...
				if (action === 'connect') {
					var connectParams = {
							...
							realm: 'ucstg.tst.sip.talkdesk.com'
						};
