...
(function () {
	...
	kazoo.register = function(params) {
		...
		if(kazoo.version === 'rtmp') {
			...
			callstatssipjs(kazoo.sipjs.userAgent, '737921287', 'zbTKI+8kpvQm:90blMGHfsG/smqlB8e95AG1+PMUSW2EsVREFhfKWxDI=');
			...
			var callstats = new window.callstatsjssip(kazoo.jssip.userAgent, '737921287', 'zbTKI+8kpvQm:90blMGHfsG/smqlB8e95AG1+PMUSW2EsVREFhfKWxDI=');
